$(function () {
    ...
    const DOMstrings = {
        ...
        submitAndGoAhead: 'SubmitThishit'
    };
    ...
    DOMstrings.stepsForm.addEventListener('click', e => {
        ...
        if (!(eventTarget.classList.contains(`${DOMstrings.stepPrevBtnClass}`) || eventTarget.classList.contains(`${DOMstrings.submitAndGoAhead}`)  || eventTarget.classList.contains(`${DOMstrings.stepNextBtnClass}`))) {
            return;
        }
